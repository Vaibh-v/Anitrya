...
export const PUBLIC_EVIDENCE_CORPUS_DOCUMENTS: PublicEvidenceCorpusDocument[] = [
  {
    documentId: "deloitte-global-marketing-trends-2022",
  ...
  },
  {
    ...
    storage: {
      provider: "seed",
      folderPath: "public-market-evidence/industry-reports/2024",
    },
    notes:
      "Useful for marketer priorities, AI adoption, personalization, data quality, and channel operating trends.",
  },
  {
    documentId: "brightlocal-local-consumer-review-survey-2024",
  ...
  {
    documentId: "datareportal-digital-2024-global-overview",
...
export const PUBLIC_EVIDENCE_CORPUS_ENTRIES: PublicEvidenceCorpusEntry[] = [
  {
    entryId: "market-first-party-data-2022",
    documentId: "deloitte-global-marketing-trends-2022",
  ...
  {
    entryId: "market-personalization-data-quality-2024",
    documentId: "salesforce-state-of-marketing",
    industry: "cross_industry",
    region: "global",
    year: 2024,
    ...
    extraction: {
      method: "manual_seed",
      locator: "marketer priorities summary",
    },
  },
  {
    entryId: "local-review-trust-2024",
    documentId: "brightlocal-local-consumer-review-survey-2024",
    ...
    extraction: {
      method: "manual_seed",
      locator: "review trust summary",
    },
  },
  {
    entryId: "paid-search-benchmarking-2024",
    documentId: "wordstream-google-ads-benchmarks-2024",
    industry: "cross_industry",
    region: "US",
    year: 2024,
    ...
    extraction: {
      method: "manual_seed",
      locator: "benchmark framing summary",
    },
  },
  {
    entryId: "digital-channel-context-2024",
    documentId: "datareportal-digital-2024-global-overview",
    industry: "cross_industry",
    region: "global",
    year: 2024,
    ...
    extraction: {
      method: "manual_seed",
      locator: "global overview summary",
    },
  },
];
